...
// Private data class.
class custom::OpticalFlowPrivate
{
...
//////////////////////////////////////////////////
void OpticalFlowPrivate::OnImage(const msgs::Image &)
{
  // No work is done here. We need to subscribe to the sensor to make it active.
}

//////////////////////////////////////////////////
bool OpticalFlowPrivate::OnRecordVideo(const msgs::VideoRecord &_msg,
    msgs::Boolean &_res)
{
  ...
  if (!this->postRenderConn)
  {
    this->postRenderConn =
        ...
        std::bind(&OpticalFlowPrivate::OnPostRender, this));
  }
...
//////////////////////////////////////////////////
void OpticalFlowPrivate::OnPostRender()
{
  // get scene
  if (!this->scene)
  {
  ...
  if (this->recordVideo)
  {
    ...
    else
    {
      ...
      this->node.Subscribe(this->sensorTopic,
          &OpticalFlowPrivate::OnImage, this);
...
GZ_ADD_PLUGIN(OpticalFlow,
                    System,
                    OpticalFlow::ISystemConfigure,
                    OpticalFlow::ISystemPostUpdate)
